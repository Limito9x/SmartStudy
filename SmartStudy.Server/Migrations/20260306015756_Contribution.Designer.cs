...
namespace SmartStudy.Server.Migrations
{
    ...
    [Migration("20260306015756_Contribution")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartStudy.Server.Entities.ContributionRule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SmartStudy.Server.Entities.ContributionValue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("ContributionRuleId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ContributionRuleId");

                    b.HasIndex("LogId");

                    b.ToTable("ContributionValues");
                });
            ...
            modelBuilder.Entity("SmartStudy.Server.Entities.Course", b =>
                {
                    ...
                    b.Property<ICollection<object>>("Grades")
                        .IsRequired()
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("SmartStudy.Server.Entities.LogItem", b =>
                {
                    ...
                    b.PrimitiveCollection<string[]>("Artifacts")
                        .HasColumnType("text[]");
            ...
            modelBuilder.Entity("SmartStudy.Server.Entities.ContributionValue", b =>
                {
                    b.HasOne("SmartStudy.Server.Entities.ContributionRule", "ContributionRule")
                        .WithMany()
                        .HasForeignKey("ContributionRuleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SmartStudy.Server.Entities.LogItem", "Log")
                        .WithMany("ContributionValues")
                        .HasForeignKey("LogId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ContributionRule");
            ...
            modelBuilder.Entity("SmartStudy.Server.Entities.LogItem", b =>
                {
                    b.Navigation("ContributionValues");
                });
